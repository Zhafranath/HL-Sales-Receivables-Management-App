      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl border p-4 animate-pulse">
            <div className="h-5 bg-zinc-200 rounded w-40 mb-4" />
            <div className="h-44 bg-zinc-100 rounded" />
          </div>
        </div>
        <div className="flex flex-col gap-6">
          <div className="bg-white rounded-xl border p-4 animate-pulse">
            <div className="h-5 bg-zinc-200 rounded w-32 mb-4" />
            <div className="h-28 bg-zinc-100 rounded-full w-28 mx-auto" />
          </div>
          <div className="bg-white rounded-xl border p-4 flex-1 animate-pulse">
            <div className="h-5 bg-zinc-200 rounded w-28 mb-4" />
            <div className="space-y-2">{[1,2,3].map((i) => (
              <div key={i} className="h-6 bg-zinc-100 rounded" />
            ))}</div>
          </div>
        </div>
      </div>
